package com.example.ewew.servicebestpractice;
...
public class DownloadService extends Service {
    ...
    private final DownloadListener listener = new DownloadListener() {
        ...
        public void onSuccess() {
            downloadTask = null;
            stopForeground(true);
            getNotificationManager().notify(1, getNotification("Downloading Success",
                    -1));
        ...
        public void onFailed() {
            downloadTask = null;
            stopForeground(true);
            getNotificationManager().notify(1, getNotification("Downloading Failed",
                    -1));
        ...
        public void onPaused() {
            downloadTask = null;
            Toast.makeText(DownloadService.this, "Pansed", Toast.LENGTH_SHORT)
                    .show();
        }
